function [ circle_img ] = ExtractCircleCornerImage( img, microImgRad, center, corner, crop_radius )
%UNTITLED3 Summary of this function goes here
%   Detailed explanation goes here

circle_img = nan(2 * crop_radius + 1, 2 * crop_radius + 1);
...
for i = 1:numel(in_microlens)
    ...
    circle_img(ceil(idy),ceil(idx)) = img(ceil(img_idy),ceil(img_idx));
